...
## Our design  
On the first day we created a design document to agree on how we organise the MongoDB database and the different screens. Here are the overviews:  
![design document](./public/images/design-document.png)
